...
def test(args):
    ...
    #resized_img = tf.resize(img, (loader.img_size[0], loader.img_size[1]), interp="bicubic")
    ...
    if model_name in ["pspnet", "icnet", "icnetBN"]:
        ...
        #img = tf.resize(img, (orig_size[0] // 2 * 2 + 1, orig_size[1] // 2 * 2 + 1))
        
    else:
        img = misc.imresize(img, (loader.img_size[0], loader.img_size[1]))
        #img = tf.resize(img, (loader.img_size[0], loader.img_size[1]))
    ...
    if model_name in ["pspnet", "icnet", "icnetBN"]:
        ...
        #pred = tf.resize(pred, orig_size, "nearest", mode="F")
    ...
    plt.colorbar()
    im1 = (decoded*18).astype(np.uint8)
    plt.colorbar()
    plt.imsave("testOutput1.png", im1) 
    plt.colorbar()
    plt.show()
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        nargs="?",
        type=str,
        default="runs/fcn8s_cityscapes/20201215_162612/fcn8s_cityscapes_best_model.pk",
